;(function () {
    ...
    var module = angular.module('mtg.auth',['mtg.socket']);

    module.controller('LoginCtrl',
        ['$scope', '$rootScope', '$location', 'socket', 'AuthenticationService',
            function ($scope, $rootScope, $location, socket, AuthenticationService) {
                // reset login status
